...
#[actix_web::test]
async fn http_exoharness_operation_records_cover_the_crash_table() {
    let fixture = http_harness().await;
    crate::contract_tests::operation_records_cover_the_crash_table(Arc::clone(&fixture.harness))
        .await;
}
